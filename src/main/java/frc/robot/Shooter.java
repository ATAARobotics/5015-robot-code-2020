...
public class Shooter {
     ...
     */
    public Shooter(CANSparkMax shooterMotor, VictorSP intakeMotor1, VictorSP intakeMotor2, CANEncoder shooterEncoder, DigitalInput intakeDetector, DigitalInput shootDetector) {
